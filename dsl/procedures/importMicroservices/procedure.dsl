...
procedure 'Import Microservices',
	description: '''<html>Create microservices in CloudBees Flow by importing a Docker Compose file.
<div>
    <ol>
    ...
    property 'stepPickerDescription',
        value: 'Create microservices in CloudBees Flow by importing a Docker Compose file.'
